...
fao1$Vegetable_item <- recode(fao1$Item, "Potatoes and products" = "Vegetable", "Vegetables, Other" = "Vegetable", 
...
fao1$Oil_item <- recode(fao1$Vegetable_item, "Soyabean Oil" = "Oil", "	Groundnut Oil" = "Oil", 
...
fao1$Animal_item <- recode(fao1$Oil_item, "Butter, Ghee" = "AnimalProducts", "Cream" = "AnimalProducts", 
