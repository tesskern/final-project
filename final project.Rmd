...
fao1$Vegetable <- recode(fao1$Item, "Potatoes and products" = "Vegetable", "Vegetables, Other" = "Vegetable", 
...
fao1$Oil <- recode(fao1$Item, "Soyabean Oil" = "Oil", "	Groundnut Oil" = "Oil", 
...
fao1$Other <- recode(fao1$Item, "Sesame seed" = "Other", "Cocoa Beans and products" = "Other", "Pepper" = "Other", 
                     ...
                     "Rape and Mustardseed" = "Other", "Aquatic Animals, Others" = "Other")

#one of these has an issue
#Error in UseMethod("recode") : 
  #no applicable method for 'recode' applied to an object of class "NULL"
fao1$Beverage <- recode(fao1$item, "Coffee and products" = "Beverage", "Tea (including mate)" = "Beverage", "Wine" = "Beverage", 
                        "Beer" = "Beverage", "Beverages, Alcoholic" = "Beverage", "Alcoholic Beverages" = "Beverage",
                        "Beverages, Fermented" = "Beverage")

fao1$Meat <- recode(fao1$Item, "Bovine Meat" = "Meat", "Mutton & Goat Meat" = "Meat", "Poultry Meat" = "Meat", 
...
fao1$AnimalProducts <- recode(fao1$Item, "Butter, Ghee" = "AnimalProducts", "Cream" = "AnimalProducts", 
...
fao1$grain <- recode(fao1$Item, "Wheat and products" = "Grain", "Rice (Milled Equivalent)" = "Grain",
...
fao1$Fruits <- recode(fao1$Item, "Nuts and products" = "Fruits", "	Coconuts - Incl Copra" = "Fruits", "Olives (including preserved)" = "Fruits", "	Tomatoes and products" = "Fruits", "Oranges, Mandarines" = "Fruits", "Citrus, Other	" = "Fruits", 
